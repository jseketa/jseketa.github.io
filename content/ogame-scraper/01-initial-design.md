...
date = 2020-08-23
path = "initial-design"
description = "Initial ponderings, decisions and abstractions."
...
```mermaid caption="The POST either yields a bearer token or it does not; only the token branch continues."
flowchart LR
...
login_post_options = {
			...
			form: {				
				'identity': process.env.OGAME_EMAIL,
